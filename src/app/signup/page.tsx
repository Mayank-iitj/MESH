      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Join the MESH Autonomous Agent Control Plane
          </p>
        </div>

        <form onSubmit={handleSignup} className="mt-8 space-y-6 bg-card/50 p-8 rounded-2xl border border-border/50 backdrop-blur-sm shadow-2xl">
          {success ? (
            <div className="p-4 bg-green-500/10 border border-green-500/20 text-green-400 text-sm rounded-lg text-center space-y-2">
              <p className="font-bold text-lg">Request Received!</p>
              <p>We'll be in touch shortly. Redirecting to login...</p>
            </div>
          ) : (
            <>
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-muted-foreground block mb-2">Work Email</label>
                  <Input 
                    type="email" 
                    value={email} 
